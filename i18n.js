(function () {
    ...
    const DICT = {
        zh: {
            ...
            tutorialQuestHint: '点击下方按钮，拍一支笔来填入这个问号。',
            tutorialScanButton: '拍照填空',
            mimiTutorialIntro: '我发现一个小信号。先点 P。',
            mimiIntroLine1: '我是 Mimi。欢迎来到语义地图。',
            mimiIntroLine2: '这里不是普通地图。附近会出现一些语义信号，靠近后就能变成任务点。',
            mimiIntroLine3: '先点亮那个 P 信号，完成第一次拍照练习吧。',
            dialogNextButton: '继续',
        ...
        ja: {
            ...
            tutorialQuestHint: '下のボタンを押して、ペンを撮影して ? に入れましょう。',
            tutorialScanButton: '撮影して埋める',
            mimiTutorialIntro: '小さな信号だよ。まず P をタップ。',
            mimiIntroLine1: 'ミミです。セマンティックマップへようこそ。',
            mimiIntroLine2: 'これは普通の地図ではありません。近くの意味信号に近づくと、タスクになります。',
            mimiIntroLine3: 'まずは P の信号をタップして、最初の撮影練習を始めましょう。',
