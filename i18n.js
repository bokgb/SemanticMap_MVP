(function () {
    ...
    const DICT = {
        zh: {
            ...
            mimiIntroLine1: '终于等到你了，天选之人。',
            mimiIntroLine2: '数字世界正在崩坏，空白正在吞掉这张地图。',
            mimiIntroLine3: '我会先为你打开一点视野。看见发光的崩坏节点后，请点一下它。',
            dialogNextButton: '继续',
        ...
        ja: {
            ...
            mimiIntroLine1: 'やっと来てくれましたね、選ばれし者。',
            mimiIntroLine2: 'デジタル世界が崩壊しています。空白がこの地図を飲みこもうとしています。',
            mimiIntroLine3: 'まずは少しだけ視野を開きます。光っている崩壊ノードをタップしてください。',
