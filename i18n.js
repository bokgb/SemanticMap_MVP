(function () {
    ...
    const DICT = {
        zh: {
            ...
            tutorialPracticeSpotName: '崩坏节点',
            collapseNodeName: '崩坏节点',
            tutorialPracticeInstruction: '拍一个物体。',
            tutorialQuestTitle: '修复崩坏节点',
            tutorialQuestHint: '拍一个现实中的物体，把它同步到崩坏节点的空白里。',
            tutorialScanButton: '拍照',
            mimiTutorialIntro: '我发现一个崩坏节点。先点它。',
            mimiIntroLine1: '终于接上了，选ばれし者。',
            mimiIntroLine2: '这里是现实背面的数字世界。现实中的物体，是我们能互相通信的唯一信号。',
            levelChoiceLead: '开始前，先告诉我你的日语水平。',
            levelChoicePrompt: '你的日语水平？',
            levelChoiceButton: '选择',
            levelChoiceComplete: '设定好了。之后我会用你能读懂的难度说明。',
        ...
        ja: {
            ...
            tutorialPracticeSpotName: '崩壊ノード',
            collapseNodeName: '崩壊ノード',
            tutorialPracticeInstruction: '物を撮ってください。',
            tutorialQuestTitle: '崩壊ノードを修復',
            tutorialQuestHint: '現実の物を撮影して、崩壊ノードの空白に同期しましょう。',
            tutorialScanButton: '撮影',
            mimiTutorialIntro: '崩壊ノードを見つけました。まずタップしてください。',
            mimiIntroLine1: 'ようやく接続できました、選ばれし者。',
            mimiIntroLine2: 'ここは現実の裏側にあるデジタル世界。現実の物体だけが、私たちをつなぐ信号になります。',
            levelChoiceLead: '始める前に、日本語レベルを教えてください。',
            levelChoicePrompt: '日本語レベルは？',
            levelChoiceButton: '選択',
            levelChoiceComplete: '設定できました。これからは、あなたが読める難度で説明します。',
