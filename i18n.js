(function () {
    ...
    const DICT = {
        zh: {
            ...
            tutorialQuestHint: '拍一张照片，把现实中的线索同步到句子空白里。',
            tutorialScanButton: '拍照',
            mimiTutorialIntro: '我发现一个崩坏节点。先点它。',
            mimiIntroLine1: '终于接上了，选ばれし者。',
            mimiIntroLine2: '这里是现实背面的数字世界。我们通过拍照，把现实和地图连接起来。',
            levelChoiceLead: '先选一个练习难度。',
            levelChoicePrompt: '选择练习难度',
            levelChoiceButton: '选择',
            levelChoiceComplete: '设定好了。现在开始调查。',
        ...
        ja: {
            ...
            tutorialQuestHint: '写真を撮って、現実の手がかりを文の空白に同期しましょう。',
            tutorialScanButton: '撮影',
            mimiTutorialIntro: '崩壊ノードを見つけました。まずタップしてください。',
            mimiIntroLine1: 'ようやく接続できました、選ばれし者。',
            mimiIntroLine2: 'ここは現実の裏側にあるデジタル世界。写真で現実と地図をつなぎます。',
            levelChoiceLead: 'まず練習の難易度を選びましょう。',
            levelChoicePrompt: '練習難易度を選択',
