(function () {
    ...
    const DICT = {
        zh: {
            ...
            mimiIntroLine1: '同步完成。我会把这个世界的信号，转换成你现在能读懂的难度。',
            mimiIntroLine2: '终于接上了，选ばれし者。这里是现实背面的数字世界。现实中的物体，是我们能互相通信的唯一信号。',
        ...
        ja: {
            ...
            mimiIntroLine1: '同期完了。世界の信号を、あなたが今読める難度に変換します。',
            mimiIntroLine2: 'ようやく接続できました、選ばれし者。ここは現実の裏側にあるデジタル世界。現実の物体だけが、私たちをつなぐ信号になります。',
